...
This free plugin was developed by [pipdig](https://www.pipdig.co?utm_source=wordpress&utm_medium=wprepo&utm_campaign=bloglovin2). Please tweet us [@pipdig](https://twitter.com/pipdig) if you have any quesitons, or use the [support forum](https://wordpress.org/support/plugin/bloglovin-button).

== Installation ==

1. Go to the "Plugins > Add New" page in your WordPress dashboard.
2. Search for "Bloglovin" - install and activate this plugin.
3. Go to 'Appearance > Widgets' in the dashboard and add the widget called "Bloglovin' Button".
...
= 1.3.4 =
* Update embed script to use https at all times.

= 1.3.3 =
* Minor code refactoring.

= 1.3.2 =
* Fix for possible isues in Customizer.

= 1.3.1 =
* Fix missing images from shortcode.

= 1.3.0 =
* Update Bloglovin scripts.

= 1.2.0 =
* Display your Bloglovin' Button in any post/page using the shortcode [bloglovin_button].
* Want to help us translate this plugin into your language? [Contact us](https://twitter.com/pipdig)!
